...
bool FV3DMaterialSoftAssetReferences::Resolve(
    FV3DMaterialAssetReferences& OutReferences,
...
int32 FV3DMaterialSoftAssetReferences::NumConfiguredReferences() const
{
