...
struct V3DSIMULATOR_API FLevelCloudSettings
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct V3DSIMULATOR_API FLevelWeatherSettings
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct V3DSIMULATOR_API FLevelGameplaySettings
{
    GENERATED_BODY()
...
class V3DSIMULATOR_API UWorldData : public UObject
{
    GENERATED_BODY()
...
public:
    ...
    /** Allows this world to mount built asset project packs from the top-level Resources directory. */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Level")
    bool bAllowProjectAssets = false;
