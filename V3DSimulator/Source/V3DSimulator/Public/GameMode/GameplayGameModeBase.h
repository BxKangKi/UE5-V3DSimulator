 ...
 * light numeric/session tuning; heavyweight asset/class references stay in UV3DSimulatorAssetRegistry.
 * Single-player and multiplayer GameModes derive from this class and share the same validated .v3d
 * startup path through UGameManagerSubSystem.
 */
UCLASS(Abstract, Blueprintable, BlueprintType)
class V3DSIMULATOR_API AV3DSimulatorGameplayGameModeBase : public AGameModeBase
{
    GENERATED_BODY()

public:
    AV3DSimulatorGameplayGameModeBase();
