 ...
 */
UCLASS(Transient)
class V3DSIMULATOR_API UMaterialDefaultRuntimeCache : public UObject
{
    GENERATED_BODY()

public:
    UPROPERTY(Transient)
    FV3DMaterialAssetReferences References;
};
...
struct V3DSIMULATOR_API FV3DMaterialSoftAssetReferences
{
    GENERATED_BODY()
    ...
    bool Resolve(FV3DMaterialAssetReferences& OutReferences, TArray<FString>& OutFailures) const;
