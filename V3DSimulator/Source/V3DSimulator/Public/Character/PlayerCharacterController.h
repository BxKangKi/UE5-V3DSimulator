...
struct V3DSIMULATOR_API FPlayerInputMappingContextConfig
{
    GENERATED_BODY()
...
class V3DSIMULATOR_API APlayerCharacterController : public APlayerController
{
    GENERATED_BODY()
...
public:
    ...
    /** U key or assigned InputAction. Cycles through built character records in the active .v3d. */
    UFUNCTION(BlueprintCallable, Category="Input|Character")
