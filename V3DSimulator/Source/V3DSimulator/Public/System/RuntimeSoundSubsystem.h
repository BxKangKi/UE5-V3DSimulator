...
/**
 * Runtime loader for AssetType=Sound entries stored in .v3d/.v3d archives.
 *
 ...
 */
UCLASS()
class V3DSIMULATOR_API URuntimeSoundSubsystem final : public UGameInstanceSubsystem
{
    GENERATED_BODY()
