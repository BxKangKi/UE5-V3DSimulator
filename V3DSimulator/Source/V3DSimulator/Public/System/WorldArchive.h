...
struct V3DSIMULATOR_API FGWorldNodeTransform
{
...
/**
 * Immutable metadata stored beside one model's decoded .dat members in a .v3d archive.
 *
 ...
 */
struct V3DSIMULATOR_API FGWorldModelMetadata
{
...
struct V3DSIMULATOR_API FGWorldBuildModel
{
...
struct V3DSIMULATOR_API FGWorldBuildSound
{
...
struct V3DSIMULATOR_API FGWorldModelSummary
{
    int32 SourceNodeCount = 0;
    int32 SourceMeshCount = 0;
    int32 SourceMaterialCount = 0;
...
/** Checksummed random-access member described by the root .v3d directory. */
struct V3DSIMULATOR_API FGWorldArchiveRange
{
    FString Name;
    uint64 Offset = 0;
    uint64 StoredSize = 0;
...
struct V3DSIMULATOR_API FGWorldModelManifest
{
 ...
 */
struct V3DSIMULATOR_API FGWorldModelRecord
{
    FModelDefinition Definition;
...
struct V3DSIMULATOR_API FGWorldSoundRecord
{
    FSoundDefinition Definition;
    FGWorldArchiveRange DefinitionRange;
...
/**
 * Thread-safe immutable .v3d reader.
 *
 ...
 */
class V3DSIMULATOR_API FGWorldArchiveReader final
...
class V3DSIMULATOR_API FGWorldArchive
{
public:
    ...
    /** Returns Worlds/WorldName.v3d for a normalized virtual WorldName root path. */
    ...
    /** Same immutable archive format, but published to an explicit path such as Resources/Pack.v3d. */
