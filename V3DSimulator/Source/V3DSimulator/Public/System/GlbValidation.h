...
namespace GlbValidation
{
    ...
    V3DSIMULATOR_API FString NormalizePath(const FString& FilePath);

    /** Validates a binary glTF container without parsing mesh data. */
    V3DSIMULATOR_API bool ValidateFile(const FString& FilePath, FString& OutReason);
     ...
     */
    V3DSIMULATOR_API bool ValidateBuildSourceFile(const FString& FilePath, FString& OutReason);
}
