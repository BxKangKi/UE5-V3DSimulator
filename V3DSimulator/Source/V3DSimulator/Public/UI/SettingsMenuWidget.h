 ...
 */
UCLASS(Transient)
class V3DSIMULATOR_API USettingsControlBinding : public UObject
{
    GENERATED_BODY()
...
class V3DSIMULATOR_API USettingsCycleButton : public UButton
{
    GENERATED_BODY()
...
class V3DSIMULATOR_API USettingsMenuWidget : public UUserWidget
{
    GENERATED_BODY()
