 ...
 *
 * Runtime mode opens WorldName.v3d and reads only its bounded directory. Authoring files are
 ...
 */
UCLASS()
class V3DSIMULATOR_API UModelDatabaseSubsystem final : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
    ...
    /** Explicit project-build mode. Scans Projects/<Project>/resources and never opens a runtime .v3d. */
    ...
    /** Returns the archive that physically owns this UUID (base .v3d or an allowed Resources .v3d). */
...
private:
    ...
    /** Per-model ownership keeps project packs mounted from top-level Resources/<Project>.v3d independent from the base world archive. */
