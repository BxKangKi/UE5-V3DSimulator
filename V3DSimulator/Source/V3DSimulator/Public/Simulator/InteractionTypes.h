...
struct V3DSIMULATOR_API FSimulatorGripPoint
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct V3DSIMULATOR_API FSimulatorCharacterInteractionConfig
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct V3DSIMULATOR_API FSimulatorEquipmentInteractionConfig
{
    GENERATED_BODY()
